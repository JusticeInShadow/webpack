...
import {Table,Input, Pagination,Select,Button ,DatePicker,Modal} from "antd";
...
import {getPayableList,
    getPayableExcel,
    changePayableSearchParams
...
class ReceiveInAdvanceComp extends Component {
    ...
    loadDataBySearch(e){
        ...
        this.props.actions.getPayableList(1,this.props.pageSize,bz,gs,khbm,kmz,mxz,date);
    }
    ...
    getExcel(){
        ...
        this.props.actions.getPayableExcel(bz,gs,khbm,kmz,mxz,date)
    }
    //搜索条件添加
    onSearchInputChange(e,type){
        ...
        this.props.actions.changePayableSearchParams(this.searchKeys);
    }
    ...
    onPageChange(page,pageSize){
        ...
        let mxz = this.props.priorSearchParams.mxz;
        let date = this.props.priorSearchParams.date;
        this.props.actions.getPayableList(page,this.props.pageSize,bz,gs,khbm,kmz,mxz,date);
    }
    ...
    componentWillUnmount() {
        ...
        this.props.actions.changePayableSearchParams(initSearchParams);
...
const mapStateToProps = (state)=> {
    let payable = state.get("payable");
    return {
        pageNumber:payable.pageNumber,
        pageSize:payable.pageSize,
        total:payable.total,
        count:payable.count,
        detail:payable.detail,
        loading:payable.loading,
        company:payable.company,
        preCompanyCode:payable.preCompanyCode,
        customer:payable.customer,
        preCustomerCode:payable.preCustomerCode,
        bz:payable.searchParams.bz,
        gs:payable.searchParams.gs,
        khbm:payable.searchParams.khbm,
        kmz:payable.searchParams.kmz,
        mxz:payable.searchParams.mxz,
        date:payable.searchParams.date,
        mciH:state.get("common").mciHeight,
        priorSearchParams:payable.priorSearchParams,
        addressList:payable.addressList,
        orginAddressList:payable.orginAddressList,
        isModalShow:payable.isModalShow,
        selectValue:payable.selectValue,
    }
};
...
const mapDispatchToProps = (dispatch)=> {
    return {
        actions: bindActionCreators({
            ...
            changePayableSearchParams:changePayableSearchParams,
            getPayableExcel:getPayableExcel,
