...
import {getReceiveInAdvanceList,
    getReceiveInAdvanceExcel,
    clearCustomerName,
    changeReceiveInAdvanceSearchParams,
    getAllAdress,
    changeAddressList,
    changeAddressModel,
...
class ReceiveInAdvanceComp extends Component {
    constructor(props) {
        super(props);
        this.searchKeys = {
            bz:"",
    ...
    loadDataBySearch(e){
        ...
        this.props.actions.getReceiveInAdvanceList(1,this.props.pageSize,bz,gs,khbm,kmz,mxz,date);
    }
    ...
    getExcel(){
        ...
        this.props.actions.getReceiveInAdvanceExcel(bz,gs,khbm,kmz,mxz,date)
    }
    //搜索条件添加
    onSearchInputChange(e,type){
        ...
        this.props.actions.changeReceiveInAdvanceSearchParams(this.searchKeys);
    }
    ...
    onPageChange(page,pageSize){
        ...
        let mxz = this.props.priorSearchParams.mxz;
        let date = this.props.priorSearchParams.date;
        this.props.actions.getReceiveInAdvanceList(page,this.props.pageSize,bz,gs,khbm,kmz,mxz,date);
    }
    ...
    componentWillUnmount() {
        ...
        this.props.actions.changeReceiveInAdvanceSearchParams(initSearchParams);
...
const mapStateToProps = (state)=> {
    let receiveInAdvance = state.get("receiveInAdvance");
    return {
        pageNumber:receiveInAdvance.pageNumber,
        pageSize:receiveInAdvance.pageSize,
        total:receiveInAdvance.total,
        count:receiveInAdvance.count,
        detail:receiveInAdvance.detail,
        loading:receiveInAdvance.loading,
        company:receiveInAdvance.company,
        preCompanyCode:receiveInAdvance.preCompanyCode,
        customer:receiveInAdvance.customer,
        preCustomerCode:receiveInAdvance.preCustomerCode,
        bz:receiveInAdvance.searchParams.bz,
        gs:receiveInAdvance.searchParams.gs,
        khbm:receiveInAdvance.searchParams.khbm,
        kmz:receiveInAdvance.searchParams.kmz,
        mxz:receiveInAdvance.searchParams.mxz,
        date:receiveInAdvance.searchParams.date,
        mciH:state.get("common").mciHeight,
        priorSearchParams:receiveInAdvance.priorSearchParams,
        addressList:receiveInAdvance.addressList,
        orginAddressList:receiveInAdvance.orginAddressList,
        isModalShow:receiveInAdvance.isModalShow,
        selectValue:receiveInAdvance.selectValue,
    }
};
...
const mapDispatchToProps = (dispatch)=> {
    return {
        actions: bindActionCreators({
            getReceiveInAdvanceList:getReceiveInAdvanceList,
            changeReceiveInAdvanceSearchParams:changeReceiveInAdvanceSearchParams,
            getReceiveInAdvanceExcel:getReceiveInAdvanceExcel,
