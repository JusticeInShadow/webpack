...
import {clearCustomerName,
    getAllAdress,
    changeAddressList,
    changeAddressModel,
    getModalResult} from "../../../actions/app/Receive";
import {getPayInAdvanceList,
    getPayInAdvanceExcel,
    changePayInAdvanceSearchParams
} from '../../../actions/app/Pay'
...
class ReceiveInAdvanceComp extends Component {
    ...
    loadDataBySearch(e){
        ...
        this.props.actions.getPayInAdvanceList(1,this.props.pageSize,bz,gs,khbm,kmz,mxz,date);
    }
    ...
    getExcel(){
        ...
        this.props.actions.getPayInAdvanceExcel(bz,gs,khbm,kmz,mxz,date)
    }
    //搜索条件添加
    onSearchInputChange(e,type){
        ...
        this.props.actions.changePayInAdvanceSearchParams(this.searchKeys);
    }
    ...
    onPageChange(page,pageSize){
        ...
        let mxz = this.props.priorSearchParams.mxz;
        let date = this.props.priorSearchParams.date;
        this.props.actions.getPayInAdvanceList(page,this.props.pageSize,bz,gs,khbm,kmz,mxz,date);
    }
    ...
    componentWillUnmount() {
        ...
        this.props.actions.changePayInAdvanceSearchParams(initSearchParams);
            ...
            <div className="GoodsSold-content">
                ...
                <div  className="Account-inner-content">
                    <div className="financial-search-keys">
                        ...
                        <div className="financial-category-search-key">
                            <i className="financial-search-key-name">供应商编码</i>
                            <Select
                                combobox={true}
                                style={{width:320}}
                                value={selectValue}
                                ...
                                onChange={(value)=>this.handleSelectChange(value,"khbm")}>
                                {options}
                            </Select>
                        </div>
                        <div className="financial-category-search-key">
...
const mapStateToProps = (state)=> {
    let payInAdvance = state.get("payInAdvance");
    return {
        pageNumber:payInAdvance.pageNumber,
        pageSize:payInAdvance.pageSize,
        total:payInAdvance.total,
        count:payInAdvance.count,
        detail:payInAdvance.detail,
        loading:payInAdvance.loading,
        company:payInAdvance.company,
        preCompanyCode:payInAdvance.preCompanyCode,
        customer:payInAdvance.customer,
        preCustomerCode:payInAdvance.preCustomerCode,
        bz:payInAdvance.searchParams.bz,
        gs:payInAdvance.searchParams.gs,
        khbm:payInAdvance.searchParams.khbm,
        kmz:payInAdvance.searchParams.kmz,
        mxz:payInAdvance.searchParams.mxz,
        date:payInAdvance.searchParams.date,
        mciH:state.get("common").mciHeight,
        priorSearchParams:payInAdvance.priorSearchParams,
        addressList:payInAdvance.addressList,
        orginAddressList:payInAdvance.orginAddressList,
        isModalShow:payInAdvance.isModalShow,
        selectValue:payInAdvance.selectValue,
    }
};
...
const mapDispatchToProps = (dispatch)=> {
    return {
        actions: bindActionCreators({
            getPayInAdvanceList:getPayInAdvanceList,
            changePayInAdvanceSearchParams:changePayInAdvanceSearchParams,
            getPayInAdvanceExcel:getPayInAdvanceExcel,
